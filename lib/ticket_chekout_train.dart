...
import 'package:hotelpedia/successkeretaapi.dart';
import 'package:intl/intl.dart';
import 'package:supercharged/supercharged.dart';

class ticket_checkout_kereta extends StatefulWidget {
  const ticket_checkout_kereta({Key? key}) : super(key: key);

  @override
  State<ticket_checkout_kereta> createState() => _ticket_checkout_keretaState();
}

class _ticket_checkout_keretaState extends State<ticket_checkout_kereta> {
        ...
        child: Column(
          children: [
            Container(
              ...
              child: Container(
                padding:
                EdgeInsets.only(left: 20, top: 17, bottom: 15, right: 20),
